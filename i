...
notificationWindow.Position = UDim2.new(0.918, -256, 0.973, -74)
...
local scrollNotification = Instance.new("ScrollingFrame")
scrollNotification.Name = "ScrollNotification"
scrollNotification.AutomaticCanvasSize = Enum.AutomaticSize.X
scrollNotification.CanvasSize = UDim2.new()
scrollNotification.ScrollBarImageColor3 = Color3.fromRGB(0, 0, 0)
scrollNotification.ScrollBarThickness = 0
scrollNotification.ScrollingDirection = Enum.ScrollingDirection.X
scrollNotification.Active = true
scrollNotification.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
scrollNotification.BackgroundTransparency = 1
scrollNotification.BorderColor3 = Color3.fromRGB(0, 0, 0)
scrollNotification.BorderSizePixel = 0
scrollNotification.Size = UDim2.new(1.19, -70, 1, 0)
ScrollNotification:TweenPosition(
    UDim2.new(0.9, -256,0.973, -74), 
...
frame.Position = UDim2.fromScale(0, 0.19)
frame.Size = UDim2.fromOffset(44, 45)
local imageLabel = Instance.new("ImageLabel")
imageLabel.Name = "ImageLabel"
imageLabel.Image = "rbxassetid://14404156927"
...
frame.Parent = scrollNotification
...
scrollNotification.Parent = notificationWindow

notificationWindow.Parent = notificationGui

local Notification = {}
function Notification:CreateNotification(TittleText,ContentText)
    ...
    tittle.Position = UDim2.fromOffset(2, -24)
    tittle.Size = UDim2.new(2.3, -40, 0.295, 22)
    tittle.Parent = frame
    ...
    description.Position = UDim2.fromOffset(9, 11)
    description.Size = UDim2.new(5.59, -40, 0.489, 22)
